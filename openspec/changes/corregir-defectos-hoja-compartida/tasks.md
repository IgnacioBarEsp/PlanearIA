...
- [x] 7.4 Aceptar con excepcion aprobada por humano los dos defectos preexistentes que descubrio la revision adversarial, en un flujo de excepciones aparte
- [x] 7.5 Gate `npm run openspec:ready:archive -- --change corregir-defectos-hoja-compartida --run-local` en PASS
