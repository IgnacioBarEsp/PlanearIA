...
- Issue upstream: https://github.com/IgnacioBarEsp/project-engineering-os/issues/8.
- PR upstream: https://github.com/IgnacioBarEsp/project-engineering-os/pull/9.
...
- Workflow: https://github.com/IgnacioBarEsp/project-engineering-os/actions/runs/30043434297, PASS.
- GitHub Release: https://github.com/IgnacioBarEsp/project-engineering-os/releases/tag/v0.1.4.
...
- `debt sync` creó el issue de saneamiento UX/UI
  https://github.com/IgnacioBarEsp/PlanearIA/issues/141 y la segunda sincronización dejó los backrefs y
  el handoff en `#141`.
