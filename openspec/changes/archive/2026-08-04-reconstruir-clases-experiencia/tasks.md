...
- [x] 4.5 Presentar la versión `candidate` al owner y detener el flujo hasta obtener aprobación visual humana explícita; no marcar frames `approved`, no declarar prototipo listo y no continuar al cierre sin esa evidencia. Presentado en [#159](https://github.com/IgnacioBarEsp/PlanearIA/issues/159#issuecomment-5164346763), iterado tras feedback del owner en [#159](https://github.com/IgnacioBarEsp/PlanearIA/issues/159#issuecomment-5173441287), corregido con puentes globales en [#159](https://github.com/IgnacioBarEsp/PlanearIA/issues/159#issuecomment-5180875043) y aprobado explícitamente en [#159](https://github.com/IgnacioBarEsp/PlanearIA/issues/159#issuecomment-5182823974).
