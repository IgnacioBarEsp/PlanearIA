...
`307:1078` y selectors `310:3`, `310:69`, `310:106`. Las tres capas mantienen la arquitectura responsive;
Office, Clases, Seguimiento, Mensajería y Agenda conservan ownership. IA es secundaria y confirmable;
sync/offline se comunica sin éxito ficticio. Figma Present y aprobación del owner siguen siendo el gate real.
...
entry actions, ejecutó validación estricta, harness parity, runtime HTTP read-only y revisión adversarial.
Quedan Present, matriz maestra, promoción, handoff y archive detenidos por la aprobación visual humana.
