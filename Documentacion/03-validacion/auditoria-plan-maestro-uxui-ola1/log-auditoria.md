...
- Deduplicacion (task 5.1): `gh search issues --repo IgnacioBarEsp/PlanearIA "<kw>"` con 14 keywords (theming, breakpoint, tokens, shell, componentes, sync status, assign, golden, prototipo, ground truth, xlsx, epic, milestone, escritorio): cero issues existentes que cubran las 12 unidades nuevas; solapes conocidos referenciados sin duplicar (#46/#47/#66/#74/#75).
