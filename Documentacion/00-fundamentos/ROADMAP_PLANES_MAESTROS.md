...
| Constructor Reutilizable de Proyectos Nuevos | `01-planes-maestros/PLAN_CONSTRUCTOR_PROYECTOS_NUEVOS.md` | ACTIVO como blueprint (2026-07). Ola 0 y distribución pública completadas; consumidor fijado en `0.1.6`; discovery y perfiles técnicos permanecen lazy por proyecto. |
...
de issues de discovery. Está publicada como `create-project-engineering-os`, con el consumidor fijado en `0.1.6`, sin frameworks,
