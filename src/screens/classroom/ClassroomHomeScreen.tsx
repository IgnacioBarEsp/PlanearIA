...
// La pantalla tiene cuatro componentes que consumen los mismos estilos. Un hook
// local evita repetir la composicion en cada uno y conserva la memoizacion: el
// objeto de useAppTheme solo cambia de identidad cuando cambia una preferencia,
// asi que el StyleSheet no se recrea en cada render.
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.heroActions}>
          ...
          >
            <MaterialIcons name="upload-file" size={20} color={DT.primary} />
          ...
          {HOME_TABS.map((tab) => (
            ...
            >
              <MaterialIcons
                name={tab.icon}
                size={18}
                color={activeTab === tab.key ? DT.primary : "#64748B"}
              />
        ...
        {isEmpty ? (
          <View style={styles.emptyCard}>
            <MaterialIcons name="auto-awesome" size={34} color={DT.primary} />
...
const KpiCard: React.FC<{
  ...
  return (
    <View style={styles.kpiCard}>
      <MaterialIcons name={icon} size={22} color={DT.primary} />
    ...
    <View style={styles.timelineCard}>
      {items.length === 0 ? (
        <View style={styles.timelineEmpty}>
          <MaterialIcons name="event-available" size={30} color={DT.primary} />
        ...
        items.map((item) => (
          <View key={item.id} style={styles.timelineRow}>
            <View style={styles.timelineIcon}>
              <MaterialIcons name={item.icon} size={20} color={DT.primary} />
            </View>
